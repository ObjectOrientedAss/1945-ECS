...
//The queue engine is automatically adapting to create an empty family queue for each family. Also useful for identification
enum e_family
{
    NoFamily = -1,
    PlayerAirplane,
...
//basic entity structure containing all the main entity informations
struct Entity
{
    ...
    aiv_vector *__components;            //the list containing all the behaviours attached to this entity
    boolean active;                    //if this is true, the behaviours of this entity's system components CAN be called, else not
    boolean __markedToDestroy;           //if this is true, the entity will be destroyed at the end of the current frame with all its components
